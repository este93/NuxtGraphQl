<template>
    <div class="list">
	  ...
	  <div class="articles__wrap">
		<Item v-for="(item, index) in allPosts" :key="index" :data="item" />

	   <!--  <article v-for="(post, index) in allPosts" :key="index" class="article__item">        
	      <nuxt-link :to="`/films/${post.slug}`">
	        ...
	        <div class="article__bottom">
	            <h4 class="article__date">January 12 — 2018</h4>
